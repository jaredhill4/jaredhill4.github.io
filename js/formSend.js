...
$(document).ready(function() { 
	...
	$('#team1').ajaxForm({ beforeSubmit: validateForm1, success: formSent, resetForm:true }); 
});

$(document).ready(function() { 
	// bind 'myForm' and provide a simple callback function 
	$('#team2').ajaxForm({ beforeSubmit: validateForm2, success: formSent, resetForm:true }); 
}); 

$(document).ready(function() { 
	// bind 'myForm' and provide a simple callback function 
	$('#team3').ajaxForm({ beforeSubmit: validateForm3, success: formSent, resetForm:true }); 
}); 

$(document).ready(function() { 
	// bind 'myForm' and provide a simple callback function 
	$('#team4').ajaxForm({ beforeSubmit: validateForm4, success: formSent, resetForm:true }); 
}); 
...
function validateForm1()
{
	...
	if ((name1==null || name1=="" || name1=="Full Name*") || (atpos<1 || dotpos<atpos+2 || dotpos+2>=email1.length) || (comments1==null || comments1=="" || comments1=="Comments*"))
	  {
		  if(name1==null || name1=="" || name1=="Full Name*"){$('#name1').addClass('error');}
		  if(atpos<1 || dotpos<atpos+2 || dotpos+2>=email1.length){$('#email1').addClass('error');}
		  if(comments1==null || comments1=="" || comments1=="Comments*"){$('#comments1').addClass('error');}
		  formError();
		  return false;
	  }
...
function validateForm2()
{
	...
	if ((name2==null || name2=="" || name2=="Full Name*") || (atpos<1 || dotpos<atpos+2 || dotpos+2>=email2.length) || (comments2==null || comments2=="" || comments2=="Comments*"))
	  {
		  if(name2==null || name2=="" || name2=="Full Name*"){$('#name2').addClass('error');}
		  if(atpos<1 || dotpos<atpos+2 || dotpos+2>=email2.length){$('#email2').addClass('error');}
		  if(comments2==null || comments2=="" || comments2=="Comments*"){$('#comments2').addClass('error');}
		  formError();
		  return false;
	  }
	  $('#dialog_outer').fadeIn(0);
...
function validateForm3()
{
	...
	if ((name3==null || name3=="" || name3=="Full Name*") || (atpos<1 || dotpos<atpos+2 || dotpos+2>=email3.length) || (comments3==null || comments3=="" || comments3=="Comments*"))
	  {
		  if(name3==null || name3=="" || name3=="Full Name*"){$('#name3').addClass('error');}
		  if(atpos<1 || dotpos<atpos+2 || dotpos+2>=email3.length){$('#email3').addClass('error');}
		  if(comments3==null || comments3=="" || comments3=="Comments*"){$('#comments3').addClass('error');}
		  formError();
		  return false;
	  }
	  $('#dialog_outer').fadeIn(0);
...
function validateForm4()
{
	...
	if ((name4==null || name4=="" || name4=="Full Name*") || (atpos<1 || dotpos<atpos+2 || dotpos+2>=email4.length) || (comments4==null || comments4=="" || comments4=="Comments*"))
	  {
		  if(name4==null || name4=="" || name4=="Full Name*"){$('#name4').addClass('error');}
		  if(atpos<1 || dotpos<atpos+2 || dotpos+2>=email4.length){$('#email4').addClass('error');}
		  if(comments4==null || comments4=="" || comments4=="Comments*"){$('#comments4').addClass('error');}
		  formError();
		  return false;
	  }
	  $('#dialog_outer').fadeIn(0);
